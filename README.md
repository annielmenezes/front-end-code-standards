...
* 1.3.0 [Project Structure](#130-project-structure)
    * 1.3.1 [Composed structures](#131-composed-structure)
* 1.4 [Indentation](#14-indentation)

### 2.0 [Javascript](#20-javascript)
* 2.1 [Strings](#21-strings)
* 2.2.0 [Names](#220-names)
    * 2.2.1 [Constants](#221-constants)
    * 2.2.2 [Private variables](#222-private-variables)
    * 2.2.3 [Constructors](#223-constructors)
    * 2.2.4 [Namespaces](#224-namespaces)
    * 2.2.5 [jQuery Elements](#225-jquery-elements)
* 2.3 [Comments](#23-comments)
* 2.4 [Variable Declarations](#24-variable-declarations)
* 2.5 [Function Declarations](#25-function-declarations)
* 2.6.0 [Statements](#260-statements)
    * 2.6.1 [Simple Statements](#261-simple-statements)
    * 2.6.2 [Compound Statements](#262-compound-statements)
    * 2.6.3 [`return` Statement](#263-return-statement)
    * 2.6.4 [`if` Statement](#264-if-statement)
    * 2.6.5 [`for` Statement](#265-for-statement)
    * 2.6.6 [`while` Statement](#266-while-statement)
    * 2.6.7 [`do` Statement](#267-do-statement)
    * 2.6.8 [`switch` Statement](#268-switch-statement)
    * 2.6.9 [`try` Statement](#269-try-statement)
    * 2.6.10 [`continue` Statement](#2610-continue-statement)
    * 2.6.11 [`with` Statement](#2611-with-statement)
    * 2.6.12 [Testing for Equality or Inequality](#2612-testing-for-equality-or-inequality)
* 2.7 [Whitespace](#27-whitespace)
* 2.8 [Do`s](#28-dos)
* 2.9.0 [Don't`s](#290-donts)
    * 2.9.1 [Use of CoffeeScript in Production](#291-use-of-coffeescript-in-production)
    * 2.9.2 [Modification of Built-in Objects and Custom Libraries](#292-modification-of-built-in-objects-and-custom-libraries)
    * 2.9.3 [Confusing Pluses and Minuses](#293-confusing-pluses-and-minuses)
...
* 3.3.0 [Other Important `<meta>` Elements](#330-other-important-meta-elements)
    * 3.3.1 [Use the Latest Rendering Engine](#331-use-the-latest-rendering-engine)
    * 3.3.2 [Mobile Viewport](#332-mobile-viewport)
* 3.4 [Optimized Google Analytics Snippet](#34-optimized-google-analytics-snippet)
* 3.5.0 [HTML Formatting](#350-html-formatting)
    * 3.5.1 [Quotes](#351-quotes)
    * 3.5.2 [Capitalization](#352-capitalization)
    * 3.5.3 [Trailing Whitespace](#353-trailing-whitespace)
    * 3.5.4 [Entity References](#354-entity-references)
    * 3.5.5 [Optional Elements](#355-optional-elements)
    * 3.5.6 [Optional Attributes](#356-optional-attributes)
* 3.6 [Semantics](#36-semantics)
* 3.7 [Separation of Concerns](#37-separation-of-concerns)
* 3.8.0 [ID and Class Naming](#380-id-and-class-naming)
    * 3.8.1 [Use Meaningful or Generic ID and Class Names](#381-use-meaningful-or-generic-id-and-class-names)
    * 3.8.2 [Use Names That are as Short as Possible but as Long as Necessary](#382-use-names-that-are-as-short-as-possible-but-as-long-as-necessary)
* 3.9.0 [Selector Performance](#390-selector-performance)
    * 3.9.1 [Avoid a Universal Key Selector](#391-avoid-a-universal-key-selector)
    * 3.9.2 [Make your Rules as Specific as Possible](#392-make-your-rules-as-specific-as-possible)
    * 3.9.3 [Remove Redundant Qualifiers](#393-remove-redundant-qualifiers)
* 3.10.0 [CSS Formatting](#3100-css-formatting)
    * 3.10.1 [Shorthand Properties](#3101-shorthand-properties)
    * 3.10.2 [0 and Units](#3102-0-and-units)
    * 3.10.3 [Quotation Marks in URI Values](#3103-quotation-marks-in-uri-values)
    * 3.10.4 [Hexadecimal Notation](#3104-hexadecimal-notation)
    * 3.10.5 [Prefixes](#3105-prefixes)
    * 3.10.6 [ID and Class Name Delimiters](#3106-id-and-class-name-delimiters)
    * 3.10.7 [Order](#3107-order)
    * 3.10.8 [Block Content Indentation](#3108-block-content-indentation)
    * 3.10.9 [Semicolons](#3109-semicolons)
    * 3.10.10 [Property Name Stops](#31010-property-name-stops)
    * 3.10.11 [Selector and Declaration Separation](#31011-selector-and-declaration-separation)
    * 3.10.12 [Rule Separation](#31012-rule-separation)
* 3.11 [Conditional Stylesheets/CSS Hacks](#311-conditional-stylesheetscss-hacks)
